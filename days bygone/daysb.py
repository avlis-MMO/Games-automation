...
'Transparent Cap':cv2.imread(os.path.join(directory_of_python_script,'helmet\\b9.png'), cv2.IMREAD_UNCHANGED), 'Crimson Beak':cv2.imread(os.path.join(directory_of_python_script,'helmet\\b10.png'), cv2.IMREAD_UNCHANGED), 'Great Helm':cv2.imread(os.path.join(directory_of_python_script,'helmet\p1.png'), cv2.IMREAD_UNCHANGED),
